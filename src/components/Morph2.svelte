...
<style>
    ...
    .button{
        ...
        transition: .5s;
        border-radius: 10px;
        clip-path: polygon(0 0, 63% 0, 100% 0, 100% 50%, 100% 100%, 64% 100%, 1% 100%);
    }
    .button:hover{
